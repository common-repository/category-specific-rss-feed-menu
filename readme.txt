...
Tags: Category Specific RSS, Wordpress category feed, custom category feed, feed, rss feed
...
= 2.3.2 =
- PHP 8 related debug notice fix.

= 2.3.1 =
- Semantic Versioning string for the plugin's version number.

= 2.3 =
- Added output escaping in the settings menu. Thanks to patchstack.com for pointint it out.

= 2.2 =
- Added nonce checking in the settings menu. Thanks to patchstack.com
- Removed the outdated widget. The standard shortcode can be used in a text editor to add it to a widget. 
